...
export const mockTrainers: Trainer[] = [
  {
    ...
    certifications: [
      ...
      },
      {
        ...
        credentialId: 'NASM-CPT-2019-5678',
      },
      {
        id: 'cert-3',
        name: 'USA Basketball Gold License',
        issuingOrganization: 'USA Basketball',
        issueDate: '2021-01-10',
        credentialId: 'USAB-GOLD-2021-9012',
      },
    ],
    achievements: [
      {
      ...
      {
        id: 'ach-2',
        title: '1000 Athletes Trained Milestone',
        description: 'Successfully trained over 1000 youth athletes across 25 camps',
        date: '2024-06-15',
        category: 'milestone',
      },
      {
        id: 'ach-3',
        title: 'Featured in Sports Training Magazine',
        description: 'Article on innovative youth basketball training methodologies',
        date: '2024-03-10',
    ...
    rating: 4.8,
    totalCamps: 25,
    campsTaught: ['camp-1', 'camp-2'],
    avatar: 'https://i.pravatar.cc/150?u=trainer1',
    bio: 'Passionate basketball trainer with over 10 years of experience working with youth athletes. Specializes in skill development and building confidence on and off the court.',
  ...
  },
  {
    ...
    certifications: [
      {
        ...
        credentialId: 'USAB-GOLD-2018-3456',
      },
      {
        id: 'cert-5',
        name: 'Positive Coaching Alliance Certification',
        issuingOrganization: 'Positive Coaching Alliance',
        issueDate: '2020-02-28',
        credentialId: 'PCA-2020-7890',
      },
    ],
    achievements: [
      {
        ...
        description: 'Led team to state championship victory in U-16 division',
        date: '2022-08-20',
        category: 'award',
      },
      {
        ...
        description: 'Recognized for providing free training to underserved communities',
        date: '2023-05-15',
    ...
    bio: 'Dedicated to youth development and creating positive sports experiences. Focused on building fundamental skills and teamwork.',
  ...
  },
  {
    ...
    certifications: [
      {
        ...
        credentialId: 'ACE-CPT-2017-2345',
      },
      {
        id: 'cert-7',
        ...
        credentialId: 'NSCA-CSCS-2018-6789',
      },
      {
        id: 'cert-8',
        name: 'Sports Nutrition Certification',
        issuingOrganization: 'International Sports Sciences Association',
        issueDate: '2019-07-10',
        credentialId: 'ISSA-SN-2019-1234',
      },
    ],
    achievements: [
      {
        id: 'ach-6',
        title: 'Published Research on Youth Athletic Development',
        description: 'Co-authored paper on injury prevention in youth athletics published in JSCR',
        date: '2023-09-01',
        category: 'publication',
      },
      {
        id: 'ach-7',
        title: 'Zero Injury Record',
        description: 'Maintained perfect safety record across 19 camps with 500+ participants',
        date: '2024-01-01',
        category: 'milestone',
      },
    ],
    ...
    bio: 'Certified strength and conditioning specialist focused on building athletic foundations safely and effectively.',
    yearsOfExperience: 8,
  },
];
